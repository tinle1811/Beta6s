        ...
        <div class="navbar-vertical-content">
          <ul class="navbar-nav navbar-nav-lg nav-tabs">
            ...
            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
              <li class="nav-item">
                <a class="nav-link " href="{{route("admin.analysis")}}" title="Thống Kê">
              ...
              <li class="navbar-vertical-aside-has-menu">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link " href="{{route("admin.form")}}" title="Danh Sách Phiếu Nhập">
                      <i class="tio-list nav-icon"></i>
                      <span class="text-truncate">Danh Sách Phiếu Nhập</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link " href="{{route("admin.form.edit")}}" title="Chi Tiết Phiếu Nhập">
                      <i class="tio-file nav-icon"></i>
                      <span class="text-truncate">Chi Tiết Phiếu Nhập</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="navbar-vertical-aside-has-menu">
                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  <li class="nav-item">
                    <a class="nav-link " href="{{route("admin.order")}}" title="Danh Sách Hoá Đơn">
                      <i class="tio-list nav-icon"></i>
                      <span class="text-truncate">Danh Sách Hoá Đơn</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link " href="{{route("admin.order.create")}}" title="Chi Tiết Hoá Đơn">
                      <i class="tio-file nav-icon"></i>
                      <span class="text-truncate">Chi Tiết Hoá Đơn</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link " href="{{route("admin.contact")}}" title="Liên Hệ">
                  ...
                  <span class="text-truncate">Liên Hệ</span>
                </a>
              </li>
            </ul>
