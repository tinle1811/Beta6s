    ...
    <div class="js-mega-menu navbar-nav-wrap">
      <div class="navbar-brand-wrapper">
        ...
        <a class="navbar-brand" href="index.html" aria-label="Front">
          <img src="{{asset("storage/logos/logo-web.jpg")}}" alt="Logo">
        </a>
      ...
      <div class="navbar-nav-wrap-content-right">
        ...
        <ul class="navbar-nav align-items-center flex-row">
                            ...
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="assetsAdmin\img\160x160\img3.jpg"
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="assetsAdmin\img\160x160\img10.jpg"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="assetsAdmin\svg\brands\google.svg"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="assetsAdmin\img\160x160\img7.jpg"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="assetsAdmin\img\160x160\img5.jpg"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-auto position-static">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="assetsAdmin\img\160x160\img8.jpg"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="nav nav-pills flex-column">
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="assetsAdmin\svg\brands\atlassian.svg"
                            alt="Image Description">
                        </span>
                    ...
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="assetsAdmin\svg\brands\slack.svg"
                            alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
                    ...
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="assetsAdmin\svg\brands\google-webdev.svg"
                            alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
                    ...
                    <a class="nav-link" href="#">
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="assetsAdmin\svg\brands\frontapp.svg"
                            alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
                      ...
                      <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3"
                            src="assetsAdmin\svg\illustrations\review-rating-shield.svg" alt="Image Description">
                        </span>
                        <div class="media-body text-truncate">
          ...
          "type": "css-animation"
                ...
                <div class="avatar avatar-sm avatar-circle">
                  <img class="avatar-img" src="assetsAdmin\img\160x160\img6.jpg" alt="Image Description">
          ...
          <li class="nav-item">
            ...
            <button type="button" class="navbar-toggler btn btn-ghost-secondary rounded-circle"
              aria-label="Toggle navigation" aria-expanded="false" aria-controls="navbarNavMenu" data-toggle="collapse"
          ...
          <ul class="navbar-nav flex-grow-1">
            ...
            <li class="hs-has-sub-menu">
              ...
              <ul id="navLinkPagesDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                ...
                <li class="hs-has-sub-menu">
                  ...
                  <ul id="navLinkPagesDropdownEcommerce" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                    ...
                    <li class="hs-has-sub-menu navbar-nav-item">
                      ...
                      <ul id="navLinkPagesDropdownEcommerceProducts" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                    ...
                    <li class="hs-has-sub-menu navbar-nav-item">
                      <a id="pagesDropdownEcommerceSublevel"
                        class="hs-mega-menu-invoker dropdown-item dropdown-item-toggle" href="javascript:;"
                        aria-haspopup="true" aria-expanded="false" aria-controls="navLinkPagesDropdownEcommerceOrders">
                    ...
                    <li class="hs-has-sub-menu navbar-nav-item">
                      ...
                      <ul id="navLinkPagesDropdownEcommerceCustomers" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                        aria-labelledby="pagesDropdownEcommerceSublevel" style="min-width: 16rem;">
                        <li>
                ...
                <!-- Email Verification -->
                <li class="hs-has-sub-menu">
                  <a id="pagesDropdownEmailVerification" class="hs-mega-menu-invoker dropdown-item dropdown-item-toggle"
                    href="javascript:;" aria-haspopup="true" aria-expanded="false"
                ...
                <!-- 2-step Verification -->
                <li class="hs-has-sub-menu">
                  <a id="pagesDropdown2StepVerification" class="hs-mega-menu-invoker dropdown-item dropdown-item-toggle"
                    href="javascript:;" aria-haspopup="true" aria-expanded="false"
            ...
            <li class="hs-has-sub-menu">
              <a id="appsNavDropdown" class="hs-mega-menu-invoker navbar-nav-link nav-link nav-link-toggle"
                href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="navLinkappsNavDropdown">
      ...
      <div class="container-fluid">
        <div class="navbar-nav-wrap">
          <div class="navbar-brand-wrapper">
            <!-- Logo -->
            <a class="navbar-brand" href="index.html" aria-label="Front">
              <img class="navbar-brand-logo" src="assetsAdmin\svg\logos\logo-white.svg" alt="Logo">
            </a>
            <!-- End Logo -->
          </div>
              ...
              <form class="position-relative">
                ...
                <div id="searchDropdownMenu"
                  ...
                  <div class="card-body-height py-3">
                    ...
                    <a class="dropdown-item my-2" href="index.html">
                      <div class="media align-items-center">
                        <img class="avatar avatar-xs avatar-circle mr-2" src="assetsAdmin\img\160x160\img10.jpg"
                          alt="Image Description">
                        <div class="media-body text-truncate">
                    ...
                    <a class="dropdown-item my-2" href="index.html">
                      <div class="media align-items-center">
                        <img class="avatar avatar-xs avatar-circle mr-2" src="assetsAdmin\img\160x160\img3.jpg"
                          alt="Image Description">
                        <div class="media-body text-truncate">
                    ...
                    <div class="card-body card-body-height">
                      ...
                      <div class="nav nav-pills flex-column">
                        <a class="nav-link" href="#">
                          <div class="media align-items-center">
                            <span class="mr-3">
                              <img class="avatar avatar-xs" src="assetsAdmin\svg\brands\atlassian.svg"
                                alt="Image Description">
                            </span>
                            <div class="media-body text-truncate">
                              <span class="h5 mb-0">Atlassian</span>
                        ...
                        <a class="nav-link" href="#">
                          <div class="media align-items-center">
                            <span class="mr-3">
                              <img class="avatar avatar-xs" src="assetsAdmin\svg\brands\slack.svg"
                                alt="Image Description">
                            </span>
                            <div class="media-body text-truncate">
                              <span class="h5 mb-0">Slack <span
                        ...
                        <a class="nav-link" href="#">
                          <div class="media align-items-center">
                            <span class="mr-3">
                              <img class="avatar avatar-xs" src="assetsAdmin\svg\brands\frontapp.svg"
                                alt="Image Description">
                            </span>
                            <div class="media-body text-truncate">
                              <span class="h5 mb-0">Frontapp</span>
                        ...
                        <a class="nav-link" href="#">
                          <div class="media align-items-center">
                            <span class="mr-3">
                              <img class="avatar avatar-xs" src="assetsAdmin\svg\illustrations\review-rating-shield.svg"
                                alt="Image Description">
                            </span>
                            <div class="media-body text-truncate">
                              <span class="h5 mb-0">HS Support</span>
