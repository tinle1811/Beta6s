  ...
  <div class="content container-fluid">
    ...
    <div class="card">
      ...
      <div class="table-responsive datatable-custom">
        <table id="datatable" class="table table-borderless table-thead-bordered table-align-middle card-table"
        ...
        <tr>
          ...
          <form action="{{ route('admin.product.delete', $product->MaSP) }}" method="POST"
