            ...
            <form action="{{ route('admin.product.update',$product->MaSP)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" value="{{ $product->TenSP }}" class="form-control" name="TenSP" id="productNameLabel" placeholder="Shirt, t-shirts, etc." aria-label="Shirt, t-shirts, etc." required>
                  </div>
                      ...
                      <div class="card-body">
                          <div id="attachFilesNewProjectLabel" class="js-dropzone dropzone-custom custom-file-boxed">
                              <div class="dz-message custom-file-boxed-label">
                                ...
                                @if($product->HinhAnh)
                                <img src="{{ asset('storage/' . $product->HinhAnh) }}" alt="{{ $product->TenSP }}" style="max-width: 100px; margin-top: 10px;">
                                @endif
                  ...
                  <div class="row">
                      <div class="col-sm-6">
                          <div class="form-group">
                              ...
                              <input type="number" value="{{ $product->SoLuong }}" class="form-control" name="SoLuong" id="quantityNameLabel" placeholder="0" min="0" required>
                          </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                          <div class="form-group">
                              ...
                              <input type="number" value="{{ $product->Gia }}" class="form-control" name="Gia" id="priceNameLabel" placeholder="0" min="0" step="0.01" required>
                          </div>
                      </div>
                  </div>
