            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        @endif
                        <form action="{{ route('admin.product.update', $viewData['product']->MaSP) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $viewData['product']->TenSP }}" class="form-control"
                                        name="TenSP" id="productNameLabel" placeholder="Shirt, t-shirts, etc."
                                        aria-label="Shirt, t-shirts, etc." required>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div id="attachFilesNewProjectLabel"
                                            ...
                                            <div class="dz-message custom-file-boxed-label">
                                                ...
                                                @if ($viewData['product']->HinhAnh)
                                                    <img src="{{ asset('storage/' . $viewData['product']->HinhAnh) }}"
                                                        alt="{{ $viewData['product']->TenSP }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $viewData['product']->SoLuong }}"
                                                class="form-control" name="SoLuong" id="quantityNameLabel" placeholder="0"
                                                min="0" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $viewData['product']->Gia }}"
                                                class="form-control" name="Gia" id="priceNameLabel" placeholder="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="MoTa" class="form-control" rows="5" placeholder="Nhập mô tả sản phẩm">{{ old('MoTa', $viewData['product']->MoTa) }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="TrangThai" id="TrangThai" class="form-control">
                                        <option value="1" {{ $viewData['product']->TrangThai == 1 ? 'selected' : '' }}>
                                            Còn Hàng
                                        </option>
                                        <option value="0" {{ $viewData['product']->TrangThai == 0 ? 'selected' : '' }}>
                                            Hết Hàng
                                        </option>
                                    </select>
                                </div>
                                    ...
                                    <select name="LoaiSP" id="LoaiSP" class="form-control" required>
                                        @foreach ($viewData['categories'] as $category)
                                            <option value="{{ $category->MaLSP }}"
                                                {{ $viewData['product']->LoaiSP == $category->MaLSP ? 'selected' : '' }}>
                                                {{ $category->TenLSP }}
                                            </option>
                                        @endforeach
                                    </select>
