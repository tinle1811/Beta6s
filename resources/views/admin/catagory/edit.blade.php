        ...
        <div class="col-sm mb-2 mb-sm-0">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('admin.catagory') }}">Loại sản
                  phẩm</a></li>
            ...
            <form
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control bg-dark text-white"
                  style="cursor: not-allowed; font-weight: bold;" name="categoryId" id="categoryIdLabel"
            ...
            <div class="js-add-field" data-hs-add-field-options='{
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-8">
                    <!-- Select2 -->
                    <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" multiple=""
                      data-hs-select2-options='{
                                "minimumResultsForSearch": "Infinity",
            ...
            <div id="addAnotherOptionFieldTemplate" style="display: none;">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-8">
                    <!-- Select2 -->
                    <select class="js-select2-custom-dynamic custom-select" size="1" style="opacity: 0;" multiple=""
                      data-hs-select2-options='{
                                "minimumResultsForSearch": "Infinity",
                                "placeholder": "Separate options with enter",
                                "tags": true
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <!-- Select -->
              <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" id="categoryLabel"
                data-hs-select2-options='{
                          "minimumResultsForSearch": "Infinity",
            ...
            <div class="form-group">
              ...
              <!-- Select -->
              <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" id="collectionsLabel"
                data-hs-select2-options='{
                          "minimumResultsForSearch": "Infinity",
