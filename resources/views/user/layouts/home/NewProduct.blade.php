                            ...
                            <figure>
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h3 class="product_name"><a
                                            href="{{ route('user.home.show', ['slug' => $product->getProductSlug()]) }}">{{ Str::limit($product->getProductName(), 20, '...') }}</a>
                                    </h3>
                                    <p class="product_description" style="font-size: .7rem">
                                        {{ Str::limit($product->getProductDescription(), 60, '...') }}</p>
                                </figcaption>
                            </figure>
                        </article>
                    @endforeach
