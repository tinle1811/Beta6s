                ...
                <div class="product-list">
                    @forelse ($viewData['DSSP_DaMua'] as $order)
                        <div class="product-item d-flex align-items-center">
                            <!-- Hình ảnh sản phẩm -->
                            <img src="{{ asset('/assetsUser/img_product/' . $order->HinhAnh) }}" alt="{{ $order->TenSP }}"
                    ...
                    @empty
                        <p class="text-center text-success fw-bold">Bạn chưa mua sản phẩm nào! <br> Danh sách sản phẩm đã
                            mua hiện đang trống</p>
                    @endforelse
                </div>
