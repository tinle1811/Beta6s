                ...
                <div class="col-lg-6 col-md-12">
                    <div class="contact_message content">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-envelope-o"> </i> Email: <a href="mailto:demo@example.com">demo@example.com
                                </a>
                            </li>
                    ...
                    <div class="contact_message form" id="contact-form-section">
                        ...
                        <form id="contact-form" method="POST">
                            ...
                            @else
                                <p>
                                    <label> Họ tên</label>
                                    <input name="name" value="{{ old('name', $viewData['taikhoan']->TenDN) }}"
                                ...
                                <p>
                                    <label> Email</label>
                                    <input name="email" value="{{ old('email', $viewData['taikhoan']->Email) }}"
                            ...
                            <div id="notification" style="display: none;"></div>
                            <button id="btnContact">Gửi</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            $('#btnContact').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            $('#notification').text(response.message).css('display', 'block')
                    ...
                    error: function(xhr) {
                        ...
                        $('.alert-danger').remove(); // Xóa cảnh báo cũ
                        for (let key in errors) {
                            $('input[name="' + key + '"], textarea[name="' + key + '"]').after(
                                '<div class="alert alert-danger">' + errors[key][0] +
                                '</div>');
                        }
                    }
                });
