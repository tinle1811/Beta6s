                    ...
                    <div class="product_d_right">
                        ...
                        <div id="sanPhamContainer" class="d-flex flex-column align-items-start gap-3">
                            <div id="sanPhamMau" class="d-flex gap-3">
                                ...
                                @auth
                                    @php
                                        $yeuThich = \App\Models\YeuThich::where('MaTK', Auth::user()->MaTK)
                                            ->where('MaSP', $viewData['sanpham']->MaSP)
                                            ->exists();
                                    @endphp
                                    ...
                                    <div class="product_variant quantity mt-3">
                                        @if ($viewData['sanpham']->TrangThai == 1 || $viewData['sanpham']->TrangThai == 2)
                                            ...
                                            <button type="submit" class="btn btn-warning" style="color:white">Thêm vào giỏ
                                                hàng</button>
                                        @else
                                            <button type="button" class="btn btn-warning" style="color:white">Thêm vào giỏ
                                                hàng</button>
                                        @endif
                                    </div>
                                </form>
