                                                            ...
                                                            <ul>
                                                                @for ($i = 1; $i <= 5; $i++)
                                                                    <li>
                                                                        <a href="#">
                                                                            <i
                                                                                class="ion-ios-star {{ $i <= round($comment->DanhGia) ? '' : '-outline' }}"></i>
                                                                        </a>
                                                                    </li>
                                                                @endfor
                                                            </ul>
                                                        </div>
                                                        <p><strong>{{ $comment->khachHang->TenKH }}</strong> -
                            ...
                            <article class="single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a class="primary_img"
                                            href="{{ route('user.home.show', ['slug' => $related->Slug]) }}"><img
                                                src="{{ asset('storage/' . $related->getProductImage()) }}"
                                                alt=""></a>
                                        ...
                                        <div class="action_links">
                                            <ul>
                                                @auth
                                                    <form
                                                        action="{{ route('user.home.addWishlist', ['id' => $related->getProductId()]) }}"
                                                        method="POST" class="add-to-cart-form" id="add-to-cart-form">
                                                        @csrf
                                                        <button type="submit" title="Add to Wishlist"
                                                            style=" border-radius: 50%;" class="btn btn-primary"><i
                                        ...
                                        <div class="add_to_cart">
                                            @auth
                                                <form
                                                    action="{{ route('user.cart.add', ['id' => $related->getProductId()]) }}"
                                                    method="POST">
                                                    @csrf
                                                    <input type="hidden" name="MaSP"
                                                        value="{{ $related->getProductId() }}">
